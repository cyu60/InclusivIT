  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-green-800">
        {/* Navbar */}
        <nav className="flex items-center justify-between bg-green-700 p-6 text-white">
        ...
        {/* Footer */}
        <footer className="flex items-center justify-center bg-green-700 p-4 text-white">
          <div className="text-center">
            © 2023 InclusivIT. All rights reserved.
          </div>
        </footer>
      </main>
    </>
